  ...
  self._updateProfile =
    ...
    content.append('script')
        ...
        .on('load', function() { self.handleClientLoad() })
          ...
          self.isLoggedInCallback =
              function(isLoggedIn) {
    self.isLoggedIn = isLoggedIn
    self._updateProfile()
    self.isAuthorizedCallbacks.forEach(function(
    ...
    gapi.load('client:auth2', function() { self.initClient() })
                  ...
                  self.updateSigninStatus =
                      function(
                          isSignedIn) { self.isLoggedInCallback(isSignedIn) }
    ...
    gapi.client
        ...
        .then(function() {
          ...
          gapi.auth2.getAuthInstance().isSignedIn.listen(function(
              data) { self.updateSigninStatus(data) })
